...
const App = () => {
  ...
  location.pathname === '/submission' || location.pathname === '/forgot-password' || location.pathname === '/reset-password/:token' || location.pathname === '/unsuccessfull/user' || location.pathname === '/successfull/user' || location.pathname === '/verify';
